...
gulp.task('clean', () => gulp.src('assets/**/*', { read: false })
  .pipe(rm()));

gulp.task('icons', () => gulp.src('src/img/icons/*.svg')
  .pipe(svgo({
    plugins: [{
...
gulp.task('scripts', () => gulp.src(lib)
...
gulp.task('images', () => gulp.src('src/img/**/*.{png,gif,jpg,svg}')
